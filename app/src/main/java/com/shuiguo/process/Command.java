...
public class Command {
	...
	/**
	 * Use am command to start activity.
	 *
	 * @param packageName       package name
	 * @param activityClazzName activity class name
	 */
	public static void startActivity(String packageName, String activityClazzName) {
		String cmd = "am start ";
		if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
			cmd += "--user 0 ";
		}

		cmd += "-n " + packageName + "/" + activityClazzName;
	...
	public static void startWeiXin() {
		...
		cmd += "-n com.tencent.mm/com.tencent.mm.ui.LauncherUI";
